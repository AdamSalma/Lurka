...
export const connectPosts = (posts) => {
  ...
  // Merge replyReferences back into original posts
  for (let i = 0; i < ids.length; i++) {
    posts[i].replyReferences = replyReferences[i];
  }
...
/**
 * Every quote that replyReferences OP (the first comment) is highlighted
